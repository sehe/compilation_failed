...
typedef std::vector<_pointer> pointer;
...
typedef std::vector<assignment_expression> expression;
...
struct unary_expression_2 : x3::variant<nil,unary_expression_1,x3::forward_ast<type_name>,postfix_expression,char> {
    using base_type::base_type;
    using base_type::operator=;
};
struct unary_expression{
...
//typedef std::vector<uint8_t> unary_expression;
...
typedef common_expression<cast_expression> multiplicative_expression;
typedef common_expression<multiplicative_expression> additive_expression;
typedef common_expression<additive_expression> shift_expression;
typedef common_expression<shift_expression> relational_expression;
typedef common_expression<relational_expression> equality_expression;

//struct and_expression{
//    equality_expression pre;
//};

typedef std::vector<equality_expression> and_expression;
typedef std::vector<and_expression> exclusive_or_expression;
typedef std::vector<exclusive_or_expression> inclusive_or_expression;
typedef std::vector<inclusive_or_expression> logical_and_expression;
typedef std::vector<logical_and_expression> logical_or_expression;
...
struct struct_declarator : x3::variant<struct_declarator_1,constant_expression,x3::forward_ast<declarator>>{
    using base_type::base_type;
    using base_type::operator=;
};
...
struct struct_declarator_list : x3::variant<std::vector<struct_declarator_list_1>,std::vector<struct_declarator>>{
    using base_type::base_type;
    using base_type::operator=;
};
...
typedef  std::string typedef_name;
typedef  std::vector<enumerator> enumerator_list;
...
struct struct_or_union_specifier : x3::variant<struct_or_union_specifier_1,struct_or_union_specifier_2,struct_or_union_specifier_3>{
    using base_type::base_type;
    using base_type::operator=;
};

struct type_specifier : x3::variant<uint8_t,struct_or_union_specifier,enum_specifier,typedef_name>{
    using base_type::base_type;
    using base_type::operator=;
};
...
struct initializer;
typedef  std::vector<x3::forward_ast<initializer>>  initializer_list;
...
struct labeled_statement : x3::variant<x3::forward_ast<statement>,labeled_statement_2,labeled_statement_1>{
    using base_type::base_type;
    using base_type::operator=;
};
...
struct iteration_statement : x3::variant<nil,_iteration_statement1,_iteration_statement2,_iteration_statement3>{
    using base_type::base_type;
    using base_type::operator=;
};
...
struct statement : x3::variant<boost::recursive_wrapper<labeled_statement>,expression_statement,boost::recursive_wrapper<compound_statement>,boost::recursive_wrapper<selection_statement>,boost::recursive_wrapper<iteration_statement>,jump_statement>{
    using base_type::base_type;
    using base_type::operator=;
};
...
typedef std::vector<x3::forward_ast<parameter_declaration>>  parameter_type_list;
// typedef parameter_list parameter_type_list;

struct _direct_abstract_declarator : x3::variant<boost::optional<constant_expression>,boost::optional<parameter_type_list>>{
    using base_type::base_type;
    using base_type::operator=;
};
...
typedef  std::vector<parameter_declaration> parameter_list;
...
struct _direct_declarator2 : x3::variant<boost::optional<constant_expression>,parameter_type_list,std::vector<std::string>>{
    using base_type::base_type;
    using base_type::operator=;
};
